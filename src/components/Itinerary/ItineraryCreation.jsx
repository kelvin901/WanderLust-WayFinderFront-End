...
import React, { useState, useEffect } from 'react';
import { useAuth } from '../../AuthContext';
import { useItinerary } from '../../ItineraryContext'; // Import the ItineraryContext
import Swal from 'sweetalert2';

const ItineraryCreation = () => {
  const { user } = useAuth();
  const { userDestinations, updateDestinations } = useItinerary(); // Get the userDestinations and updateDestinations from the context
  const handleAddItinerary = () => {
    Swal.fire({
      title: 'Create Itinerary',
      html: `
